...
# Ensure logs directory exists with open permissions
...
# Disable COOP header — not effective over plain HTTP on non-localhost origins
...
# Result settings
CELERY_RESULT_EXPIRES = int(os.getenv('CELERY_RESULT_EXPIRES', '3600'))  # 1 day
